...
$lista = $escritorio->listar();
?>

<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>Escritórios</h1>
        <a href="form_escritorio.php" class="btn btn-primary">
            <i class="bi bi-plus"></i> Novo Escritório
        </a>
    </div>
                        ...
                        <?php foreach ($lista as $row): ?>
                            <tr>
                                ...
                                <td class="table-cell-actions">
                                    <div class="btn-group">
                                        <a href="form_escritorio.php?id=<?php echo (int) $row['id']; ?>" class="btn btn-sm btn-warning" title="Editar">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <a href="ordens_servico/os.php?tipo=escritorio&id_equipamento=<?php echo (int) $row['id']; ?>" class="btn btn-sm btn-success" title="Nova OS">
