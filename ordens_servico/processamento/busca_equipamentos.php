...
try {
    ...
    switch ($tipo) {
        ...
        case 'tanque':
            ...
            break;
        case 'patio':
            $sql = "SELECT id, nome as identificacao FROM patios ORDER BY nome";
            break;
        case 'oficina':
            $sql = "SELECT id, nome as identificacao FROM oficinas ORDER BY nome";
            break;
        case 'escritorio':
            $sql = "SELECT id, nome as identificacao FROM escritorios ORDER BY nome";
            break;
        default:
