...
$titulos_tipo_os = [
    'embarcacao' => 'Embarcações', 'veiculo' => 'Veículos', 'implemento' => 'Implementos', 'tanque' => 'Tanques',
    'patio' => 'Pátios', 'oficina' => 'Oficinas', 'escritorio' => 'Escritórios',
];
$titulo_lista_tipo = $titulos_tipo_os[$tipo_equipamento] ?? (ucfirst($tipo_equipamento) . 's');
} catch (Exception $e) {
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>Ordens de Serviço — <?php echo htmlspecialchars($titulo_lista_tipo); ?></h1>
        <div>
