        ...
        <div class="col-md-8">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <p><strong>Tipo de Equipamento:</strong> <?php echo htmlspecialchars($labels_tipo_equipamento[$os['tipo_equipamento']] ?? ucfirst($os['tipo_equipamento'])); ?></p>
