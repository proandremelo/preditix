...
$labels_tipo_lista = [
    'embarcacao' => 'Embarcação', 'veiculo' => 'Veículo', 'implemento' => 'Implemento', 'tanque' => 'Tanque',
    'patio' => 'Pátio', 'oficina' => 'Oficina', 'escritorio' => 'Escritório',
];
                        ...
                        <tbody>
                            <?php foreach ($ordens_servico as $os): ?>
                                <tr>
                                    ...
                                    <td class="table-cell-text" title="<?php echo htmlspecialchars($labels_tipo_lista[$os['tipo_equipamento']] ?? $os['tipo_equipamento']); ?>"><?php echo htmlspecialchars($labels_tipo_lista[$os['tipo_equipamento']] ?? ucfirst($os['tipo_equipamento'])); ?></td>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select name="tipo" id="tipo" class="form-select">
                                    ...
                                    <option value="patio" <?php echo ($filtros['tipo_equipamento'] ?? '') === 'patio' ? 'selected' : ''; ?>>Pátio</option>
                                    <option value="oficina" <?php echo ($filtros['tipo_equipamento'] ?? '') === 'oficina' ? 'selected' : ''; ?>>Oficina</option>
                                    <option value="escritorio" <?php echo ($filtros['tipo_equipamento'] ?? '') === 'escritorio' ? 'selected' : ''; ?>>Escritório</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
