...
// Pátio, oficina e escritório: mesma base de listas que tanque (instalações / ativos fixos)
$cfg_os_instalacao = [
    'sistemas' => [
        'estrutural' => 'Estrutura geral',
        'medicao_controle' => 'Sistema de medição e controle',
...
$config_campos['patio'] = $cfg_os_instalacao;
$config_campos['oficina'] = $cfg_os_instalacao;
$config_campos['escritorio'] = $cfg_os_instalacao;
