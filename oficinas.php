...
$lista = $oficina->listar();
?>

<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>Oficinas</h1>
        <a href="form_oficina.php" class="btn btn-primary">
            <i class="bi bi-plus"></i> Nova Oficina
        </a>
    </div>
                        ...
                        <?php foreach ($lista as $row): ?>
                            <tr>
                                ...
                                <td class="table-cell-actions">
                                    <div class="btn-group">
                                        <a href="form_oficina.php?id=<?php echo (int) $row['id']; ?>" class="btn btn-sm btn-warning" title="Editar">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <a href="ordens_servico/os.php?tipo=oficina&id_equipamento=<?php echo (int) $row['id']; ?>" class="btn btn-sm btn-success" title="Nova OS">
