                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="equipamentosDropdown">
                                ...
                                <li>
                                    <a class="dropdown-item" href="<?php echo $base_url; ?>/patios.php">
                                        <i class="bi bi-grid-1x2 me-2 text-secondary"></i> Pátios
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="<?php echo $base_url; ?>/oficinas.php">
                                        <i class="bi bi-tools me-2 text-dark"></i> Oficinas
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="<?php echo $base_url; ?>/escritorios.php">
                                        <i class="bi bi-building me-2 text-primary"></i> Escritórios
                                    </a>
                                </li>
                            </ul>
                        </li>
